...
and (b) save data from a session to a .txt / .csv file. 

Instructions for connection:

1. From the 'Serial Ports' drop down menu on the top left, select /DEV/CU.USBMODEMXXXXX (for Windows, see bullet below)
    + This is a list that includes all of the things that could connect to your machine, over USB, Bluetooth, et cetera
    + On Windows, this will appear as a COM port
...
Please do not modify the code below. If you happen to, you can always retrieve a fresh copy from Canvas. 
...
String portName;
int baudRate;
int[] baud = {9600, 19200, 28800, 38400, 57600, 115200, 2000000};
int itemSelected;
